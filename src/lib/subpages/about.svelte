...
<SubpageContent flexDirection="row" accent="{accent}">
  <svelte:fragment slot="heading">
...
<div class="flex-col flex items-center">
  <h2 class="text-about max-w-[80%]" style="color: {accent}">
  ...
  >
    <div class="md:basis-1/2 max-w-[80%]">
      <p>
        ...
        here—even to contribute—this is what I have for now. My ears are open,
        and as such, I may take my time to consider before replying. I'll get
