...
<article>
    <div class="homepage-section-container">
        <div class="homepage-section about hover-color scale-transition">
            <div class="homepage-section-menu-link about">
                <h1>about</h1>
            </div>
        </div>
        <div class="homepage-section studio hover-color scale-transition">
            <div class="homepage-section-menu-link studio">
                <h1>studio</h1>
            </div>
        </div>
        <div class="homepage-section commissions hover-color scale-transition">
            <div class="homepage-section-menu-link commissions">
                <h1>commissions</h1>
            </div>
            div>
        </div>
        <div class="homepage-section shop hover-color scale-transition">
            <div class="homepage-section-menu-link shop">
                <h1>shop</h1>
            </div>
        </div>
        <div class="homepage-section news hover-color scale-transition">
            <div class="homepage-section-menu-link news">
                <h1>news</h1>
            </div>
        </div>
        <div class="homepage-section-content about hide invisible">
            <div class="section-content-div border-1 max-width-40">
                <h2 class="section-content-heading">
        ...
        <div class="homepage-section-content studio hide invisible">
            <div class="section-content-div">
                <img
        ...
        <div class="homepage-section-content commissions hide invisible">
            <div class="section-content-div border-1 max-width-40">
                <h2 class="section-content-heading">
        ...
        <div class="homepage-section-content shop hide invisible">
            <div class="section-content-div">
                <img
            ...
            <div class="section-content-div border-1 max-width-40">
                <h2 class="section-content-heading">grab a gift (soon).</h2>
                <p>
        ...
        <div class="homepage-section-content news hide invisible">
            <div class="section-content-div border-1 max-width-40">
                <h2 class="section-content-heading">let's keep in touch.</h2>
                <p>
...
<!-- <footer>
      <div>
        <p>Here there will be a footer.</p>
      </div>
    </footer> -->
<!-- About -->
